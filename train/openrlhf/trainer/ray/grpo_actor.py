...
from openrlhf.trainer import GRPOTrainer, GRPOTrainerPRM800K_BOX
...
from .launcher import BaseGRPORole
...
class ActorGRPOTrainerBOX(GRPOTrainerPRM800K_BOX):
    def __init__(
        self,
        *args,
        vllm_engines: List = None,
...
class ActorModelRayActor(BaseGRPORole):
...
@ray.remote(num_gpus=1)
class ActorModelRayActorBOX(BaseGRPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        args = strategy.args
        self._setup_distributed(strategy)
...
@ray.remote(num_gpus=1)
class ActorModelRayActorPRMBOX(BaseGRPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        args = strategy.args
        self._setup_distributed(strategy)
    ...
    def fit(
        ...
        # configure Trainer
        trainer = ActorGRPOTrainerPRMBOX(
            strategy,
            self.actor,
            critic_model,
            reward_model,
...
class ActorGRPOTrainerPRMBOX(GRPOTrainerPRM800K_BOX):
    def __init__(
        self,
        *args,
        vllm_engines: List = None,
...
@ray.remote(num_gpus=1)
class ActorModelRayActorORMBOX(BaseGRPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        args = strategy.args
        self._setup_distributed(strategy)
    ...
    def fit(
        ...
        # configure Trainer
        trainer = ActorGRPOTrainerORMBOX(
            strategy,
            self.actor,
            critic_model,
            reward_model,
...
class ActorGRPOTrainerORMBOX(GRPOTrainerPRM800K_BOX):
    def __init__(
        self,
        *args,
        vllm_engines: List = None,
