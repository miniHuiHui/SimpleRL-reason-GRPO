...
class GRPOTrainerPRM800K_BOX(ABC):
    """
    Trainer for Proximal Policy Optimization (GRPO) algorithm.

    Args:
        strategy (Strategy): The training strategy to use.
        actor (Actor): The actor model in the GRPO algorithm.
        critic (nn.Module): The critic model in the GRPO algorithm.
